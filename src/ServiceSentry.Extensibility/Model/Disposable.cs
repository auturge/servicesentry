...
namespace ServiceSentry.Extensibility
{
    ...
    ///     and <see cref="T:System.ComponentModel.INotifyPropertyChanged" /> patterns.
    /// </summary>
    /// <example>
    ...
    /// </example>
    [DataContract]
    public class Disposable : NotifyPropertyChanged, IDisposable
    {
        /// <summary>
        ///     Tracks whether <see cref="M:ServiceSentry.Extensibility.Disposable.Dispose" /> has been called or not.
        /// </summary>
        ...
        ///     should override
        ///     <see
        ///         cref="M:ServiceSentry.Extensibility.Disposable.Dispose(System.Boolean)" />
        ///     .
        /// </remarks>
        [DebuggerStepThrough]
        public void Dispose()
        ...
        ///     <see
        ///         cref="M:ServiceSentry.Extensibility.Disposable.Dispose" />
        ...
        /// </param>
        /// <remarks>
        ///     Check the <see cref="P:ServiceSentry.Extensibility.Disposable.IsDisposed" /> property to determine whether
